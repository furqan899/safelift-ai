...
from .serializers import LoginSerializer, TokenResponseSerializer, LogoutSerializer
...
class LogoutView(APIView):
    ...
    @extend_schema(
        ...
        responses={
            200: OpenApiResponse(
                response=LogoutSerializer, description="Logout successful"
            )
        },
        tags=["Authentication"],
    )
...
class ReadinessProbeView(APIView):
    ...
    @extend_schema(
        ...
        responses={200: OpenApiResponse(description="API is ready")},
        tags=["System"],
    )
...
class LivenessProbeView(APIView):
    ...
    @extend_schema(
        ...
        responses={200: OpenApiResponse(description="API is live")},
        tags=["System"],
    )
    def get(self, request):
